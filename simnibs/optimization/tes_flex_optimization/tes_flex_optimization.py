...
from simnibs.utils.TI_utils import get_dirTI, get_maxTI
...
from .ellipsoid import Ellipsoid, ellipsoid2subject, subject2ellipsoid
from .measures import AUC, ROC, integral_focality
