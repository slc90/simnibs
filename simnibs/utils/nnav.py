...
from ..simulation.sim_struct import POSITION, TMSLIST
...
class localite:
    ...
    def write(
        ...
        with io.open(
            ...
            f.write(
                f"    <!--This InstrumentMarkerList was written by SimNIBS v4.5.0-->\n"
            )
...
class brainsight:
    ...
    def write(self, matsimnibs, fn, names=None, overwrite=False):
        ...
        with open(fn, "w", encoding="utf-8") as f:
            ...
            f.write(f"# Created by: SimNIBS v4.5.0\n")
...
class ant:
    ...
    def _mrk_template(self):
        mrk_template = {
            "Configuration": {
                "SourceInfo": {"AppName": "SimNIBS", "AppVersion": "4.5.0"},
                "AssociatedImageInfo": {
