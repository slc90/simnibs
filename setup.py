...
if sys.platform == "win32":
    # CGAL
    cgal_dirs = [r"C:/Users/50609/Documents/vcpkg/installed/x64-windows/lib"]
    cgal_libs = ["mpfr", "gmp", "zlib", "tbb12", "tbbmalloc"]
    cgal_include = [
        np.get_include(),
        r"./include/CGAL-5.5.1/include",
        r"./include/boost_1_78_0",
        r"./include/eigen-3.4.0",
        r"C:/Users/50609/Documents/vcpkg/installed/x64-windows/include",
    ]
...
cat_c_utils = Extension(
    ...
    [
        ...
        "simnibs/segmentation/cat_c_utils/genus0.c",
    ],
...
setup(ext_modules=extensions, cmdclass={"build_ext": build_ext_})
